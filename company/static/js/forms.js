$(function () {
    ...
    function update_cart_item(url, cnt, dates, cart_id, company_id, success_f) {
        var data = {
            'cnt': cnt,
            'dates': dates,
            'cart_id': cart_id,
    ...
    function update_cart_subtotal() {
        ...
        $('.row.results').each(function (id, el) {
            ...
            if (fade_update(el_sum, sum.toFixed(2))) {
                update_cart_item(url, cnt, dates, cart_id, company_id, function() {});
            }
    ...
    function init_cart() {
        ...
        $('.cart_delete').on('click', function(e) {
            ...
            update_cart_item(url, 0, dates, cart_id, company_id, function(res) {
